<template>
  ...
  >
    ...
    <path
      ...
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M4 19L10 11L16 19H4Z"
      fill="white"
    />
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M11 19L15 14L19 19H11Z"
      fill="white"
    />
    <path
      opacity="0.3"
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M18 12C18.8284 12 19.5 11.3284 19.5 10.5C19.5 9.67157 18.8284 9 18 9C17.1716 9 16.5 9.67157 16.5 10.5C16.5 11.3284 17.1716 12 18 12Z"
      fill="white"
    />
  </svg>
</template>
